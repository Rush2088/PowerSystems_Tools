...
import ThreeWdgTxCard from '../components/ThreeWdgTxCard';
import { DEFAULT_VALUES, validateInputs, calculateThreeWdgTx } from '../utils/threeWdgTxCalc';
...
export default function Home() {
  ...
  const { result, error } = useMemo(() => {
    ...
    const calc = calculateThreeWdgTx(validation.parsed);
    if (calc.error) return { result: null, error: calc.error };
    return { result: calc, error: '' };
  }, [values]);
