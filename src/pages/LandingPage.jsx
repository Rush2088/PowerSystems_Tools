    ...
    <button
      ...
      className={
        primary
          ...
          : 'rounded-3xl border border-white/10 bg-white/5 px-6 py-6 text-left text-white transition hover:bg-white/10'
      }
    >
      ...
      <div className="mx-auto max-w-4xl glass-card p-6 sm:p-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-base text-slate-300 sm:text-lg">
            Open either the IEC 60909 fault level calculator or the grid source impedance calculator from a single GitHub Pages site.
          </p>
        </div>
