...
import TransformerRXCard from '../components/TransformerRXCard';
import { DEFAULT_VALUES, validateInputs, calculateTransformerRX } from '../utils/transformerRXCalc';
...
export default function Home() {
  ...
  const { result, error } = useMemo(() => {
    ...
    return { result: calculateTransformerRX(validation.parsed), error: '' };
  }, [values]);
